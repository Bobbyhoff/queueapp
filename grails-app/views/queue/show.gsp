...
<html>
    ...
    <body>
        ...
        <div id="show-queue" class="content scaffold-show" role="main">
            ...
            <f:display bean="queue" />
            <g:form resource="${this.queue}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.queue}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
